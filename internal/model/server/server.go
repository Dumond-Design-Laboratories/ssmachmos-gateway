...
var pairingServicePtr *bluetooth.Service
var pairingService bluetooth.Service
...
func Init(sensors *[]model.Sensor) {
	...
	adapter.AddService(pairingServicePtr)
...
func StartPairing() {
	...
	//pairingEnabled = true
	pairingServicePtr = &pairingService
